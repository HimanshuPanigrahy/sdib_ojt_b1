...
#define FILE_NAME  "HimanshuLibBook.bin"
...
void searchBooks()
{
    ...
    if(found)
    {
        ...
        printf("\t\t\tIssued by = %s", addBookInfoInDataBase.studentName);
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="Himanshu\n";
    const char defaultPassword[] ="Hp7\n";
    sFileHeader fileHeaderInfo = {0};
